...
Route::group(['namespace' => 'App\Http\Controllers\PublicBackend'], function () {
    ...
    Route::get('/about/index.html', 'AboutController@index')->name('about');
    Route::get('/categories/{id}/index.html', 'CategoriesController@show')->name('categories.show');
    Route::get('/posts/{id}/index.html', 'PostsController@show')->name('posts.show');
});
